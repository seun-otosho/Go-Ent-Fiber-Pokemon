...
func (m *NoteMutation) SetPrivate(b bool) {
	m._Private = &b
}

// Private returns the value of the "Private" field in the mutation.
func (m *NoteMutation) Private() (r bool, exists bool) {
	v := m._Private
	if v == nil {
		return
	}
...
// OldPrivate returns the old "Private" field's value of the Note entity.
// If the Note object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NoteMutation) OldPrivate(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *NoteMutation) ResetPrivate() {
	m._Private = nil
}
...
func (m *NoteMutation) Fields() []string {
	...
	if m._Private != nil {
		fields = append(fields, note.FieldPrivate)
	}
	if m.created_at != nil {
